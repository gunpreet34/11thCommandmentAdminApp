...
public class ShowUnverifiedCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Unverified Categories");
    ...
    private void setupRecyclerViewForCategories() {
        ...
        Animation animation = AnimationUtils.loadAnimation(ShowUnverifiedCategoriesActivity.this,R.anim.splash);
        recyclerView.setAnimation(animation);
        //Setting recycler view adapter
        DatabaseHandler db = new DatabaseHandler(this);
        try {
            db.getUnverifiedCategories(new VolleyCallback(){
                @Override
            ...
            Log.d("SHOW UNV CAT ACTIVITY","SetupRecyclerView " + e.toString());
        }
    }
